# This file contains a script for Supervised Fine-Tuning (SFT) on a Text-to-SQL task.
...
USER_PROMPT = """Given the <USER_QUERY> and the <SCHEMA>, generate the corresponding SQL command to retrieve the desired data, \
considering the query's syntax, semantics, and schema constraints.
