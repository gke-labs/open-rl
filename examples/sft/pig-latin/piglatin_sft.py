# This file contains a script for Supervised Fine-Tuning (SFT) on a Pig Latin translation task.
...
def evaluate(
  client: Any, trainer: Any, tokenizer: Any, alias: str, examples: list[dict[str, Any]], max_tokens: int
