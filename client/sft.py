...
async def run_sft(service_client, client_name: str, target_answer: str, max_epochs: int = 20, plot_callback=None):
    ...
    questions = [
        "What's the weather like today?", "How do I reset my password?",
        "Can you explain quantum computing?", "What are the health benefits of exercise?",
        "How do I bake chocolate chip cookies?", "What's the capital of France?",
        "How does photosynthesis work?", "What are some good books to read?",
        "How can I learn Python programming?", "What causes climate change?"
    ]
