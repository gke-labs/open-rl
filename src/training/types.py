"""Wire types shared by the API server, the request queue and the trainer workers.

Nothing here imports torch, so the API server can build and validate commands
